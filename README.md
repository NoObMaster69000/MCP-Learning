...
The tutorial is structured as a series of 10 Python notebooks located in the `mcp_tutorial/` directory.

## Quick Start

1.  **Explore the Tutorial**: Head over to [mcp_tutorial/README.md](mcp_tutorial/README.md) for a detailed overview.
